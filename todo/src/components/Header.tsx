function Header() {
  return (
    <div className="my-4">
      <h2 className="text-2xl font-normal my-8">TODO LIST</h2>
      <div className="flex items-center gap-4 justify-center w-full">
        <form className="w-full">
          <div className="relative overflow-hidden border border-blue-600 rounded-lg px-4 py-2 flex items-center gap-6 justify-between">
            <input
            ...
            <svg
              ...
              height="1em"
              viewBox="0 0 24 24"
              className="absolute right-0  text-2xl h-12 w-12 bg-blue-600 hover:bg-blue-800 transition-colors text-[#ececec] cursor-pointer px-2"
            >
              <path
                fill="currentColor"
